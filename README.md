...
It is based on CloudBees' [default Lift 2.4 ClickStart](https://github.com/CloudBees-community/lift_template) but does *not* include
a MySQL instance, only the default [H2 DB](http://www.h2database.com) integrated into Lift.
